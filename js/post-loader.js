...
(function () {
  ...
  function loadGiscus() {
    ...
    script.setAttribute(
      "data-repo",
      "dbdnjswns032-cloud/dbdnjswns032-cloud.github.io"
    );
    script.setAttribute("data-repo-id", "R_kgDOQec19w"); // GitHub Discussions 설정 후 변경 필요
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOQec1984CzIzi"); // GitHub Discussions 설정 후 변경 필요
